...
$prt_data = mysqli_fetch_assoc($result);
  ...
  <footer id="footer" class="footer dark-background">
    <div class="container">
      ...
      <?php
          if ($prt_data['twitter']) {
          ?>
            <a href="<?= $prt_data["twitter"] ?>" target="_blank"><i class="bi bi-twitter-x"></i></a>
          <?php
          }
          ?>
          <?php
          if ($prt_data['facebook']) {
          ?>
            <a href="<?= $prt_data['facebook'] ?>" target="_blank"><i class="bi bi-facebook"></i></a>

          <?php
          }
          ?>
          <?php
          if ($prt_data['instagram']) {
          ?>
            <a href="<?= $prt_data['instagram'] ?>" target="_blank"><i class="bi bi-instagram"></i></a>
          <?php
          }
          ?>
          <?php
          if ($prt_data['linkedin']) {
          ?>
            <a href="<?= $prt_data['linkedin'] ?>" target="_blank"><i class="bi bi-linkedin"></i></a>
          <?php
          }
          ?>
          <?php
          if ($prt_data['github']) {
          ?>
            <a href="<?= $prt_data['github'] ?>" target="_blank"><i class="bi bi-github"></i></a>
          <?php
          }
          ?>
      </div>
      <div class="container">
        ...
        <div class="credits">
          Designed by <a href="#"><?=$prt_data['name']?></a>
        </div>
      </div>
    </div>
  </footer>
